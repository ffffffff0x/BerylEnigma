...
public class ReverseShellGeneratorImpl {
    private Map<String,String> ListenerType = new HashMap<>();
    private ReverseShellBeans reverseShellBeans;

    public ReverseShellGeneratorImpl() {
        initListenerType();
        String jsonData = new BufferedReader(new InputStreamReader(ReverseShellGeneratorImpl.class.getResourceAsStream("/json/redTeam/ReverseShell.json")))
