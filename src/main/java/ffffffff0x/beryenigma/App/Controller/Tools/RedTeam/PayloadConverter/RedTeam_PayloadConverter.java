package ffffffff0x.beryenigma.App.Controller.Tools.RedTeam.PayloadConverter;
...
public class RedTeam_PayloadConverter {
    ...
    private String powerShellConverter(String payload) {
        String bs64 = "";
        try {
            bs64 = Coding_Base64.encodeToString(payload, "UTF-16LE");
    ...
    private String commonConverter(String initPayload,String payload) {
        String bs64 = "";
        try {
            bs64 = Coding_Base64.encodeToString(payload, "UTF-8");
