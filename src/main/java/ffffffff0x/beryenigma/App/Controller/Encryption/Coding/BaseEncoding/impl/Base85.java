package ffffffff0x.beryenigma.App.Controller.Encryption.Coding.BaseEncoding.impl;
...
public class Base85 {
    ...
    public static abstract class Encoder {
         ...
         * @see <a href="https://tools.ietf.org/html/rfc1924">...</a>
        ...
        public String getCharset() { return new String( getEncodeMap(), StandardCharsets.US_ASCII); }
    }
     ...
     *
     * Encoder instances can be safely shared by multiple threads.
     * @see <a href="https://rfc.zeromq.org/spec:32/Z85/">...</a>
     */
     ...
     *
     * Encoder instances can be safely shared by multiple threads.
     * @see <a href="https://en.wikipedia.org/wiki/Ascii85">...</a>
     */
     ...
     * Just override and {@link #getName()} to create a fully functional decoder.
...
//        System.out.println((getAscii85Encoder().encode("沃日")));
//        System.out.println((getRfc1924Encoder().encode("沃日")));
//        System.out.println((getZ85Encoder().encode("沃日")));
//        System.out.println((getAscii85Decoder().decode("k-BX%Q_a")));
//        System.out.println((getRfc1924Decoder().decode("=CXt4m!$")));
//        System.out.println((getZ85Decoder().decode(">cxT4M.:")));
//    }
}