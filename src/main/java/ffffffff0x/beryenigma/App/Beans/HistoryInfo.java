...
public class HistoryInfo {
    ...
    public HistoryInfo(Long timestamp, String input, String output, String module, String action, HistoryConfig[] config) {
    ...
    public HistoryInfo(String input, String output, String module, String action, HistoryConfig[] config) {
    ...
    public void setConfig(HistoryConfig[] config) {
        this.config = config;
    }
}
