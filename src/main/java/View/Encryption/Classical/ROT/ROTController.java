...
public class ROTController {
    ...
    @FXML private JFXComboBox JCB_select;
    ...
    public void ONInputAndSelect(){
        JTA_dst.setText(ClassicalROT.encode(JTA_src.getText(),JCB_select.getValue().toString()));
    }

    public void initComboxSelect(){
        JCB_select.getItems().addAll("ROT01",
        ...
        JCB_select.setValue("ROT13");
        JCB_select.setVisibleRowCount(6);
    }
}
